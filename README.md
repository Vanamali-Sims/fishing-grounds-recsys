...
> Populate as the project progresses. Report against the popularity baseline — a recommender that can't beat "recommend the busiest cells" isn't doing anything.
